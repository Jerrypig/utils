class OtherFn {
    ...
    /**
     * 简易版深度克隆,如实现更复杂的功能请用下面的方法
     * @param {any} obj 参数
     * @return {any} 克隆的结果
     */
    deepClone(obj) {
        var result,
            oClass = this.whichClass(obj);
        if (oClass === 'Object') {
            result = {};
        }
     ...
     * 扩展获取类型的方法
     * @param {any} arg 参数
     * @return {string} Null, Undefined, String, Number, Object, Function, Array,
     */
    whichClass(arg) {
        if (arg === null) {
            return 'Null';
        ...
        // 从第九位开始截取
        var str = Object.prototype.toString.call(arg).slice(8, -1);
        return str;
    }
